...
function Showlike(props){
    ...
    async function like(ind,postname){
        if(document.getElementById(ind).style.color === 'red'){
          let Notlike  =  await axios.post('https://socialmedia-orpin.vercel.app/Socialmedia/decreaselike?postemail='+props.postemail+'&email='+localStorage.getItem('email')+'&postname='+postname)
          console.log(Notlike)
    ...
    let like  =  await axios.post('https://socialmedia-orpin.vercel.app/Socialmedia/increaselike?postemail='+props.postemail+'&email='+localStorage.getItem('email')+'&postname='+postname)         
    console.log(like)
