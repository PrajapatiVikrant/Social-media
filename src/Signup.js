...
function Signup(){
 ...
 async function signup(){
    let data = await axios.post('https://socialmedia-vikrant.vercel.app/Socialmedia/signup?name='+name+'&email='+email+'&password='+password+'&discription='+discription+'&visit='+email);
